...
```
Looks like the optimal amount of neighbors is 29.
...
The top 10 variables all heed from the per-game subset, with the top 2 in a separate tier of importance from the others.
